...
| **15. Mode TPS** | Aim over-the-shoulder (kamera bahu + strafe + shoulder swap), projectile server-authoritative masuk pipeline damage penuh, spread cone, anim vars (bIsAiming/AimPitch) | ✅ kode selesai — [Docs/TPS_MODE.md](Docs/TPS_MODE.md) |
