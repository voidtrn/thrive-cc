...
function ImportClaimSFF(props){
    ...
    const submit= async () =>{
        ...
        if(IsFileAttached){
            ...
            let responseJson = await axiosLibrary.postData("awbRegisterCourse/S2CourseImportData", fd);
            if(responseJson.status === 200){
                alert("DATA HAS BEEN CREATED");
                history.push(routeAdmin.registerCourse.path)
            }else{
                alert(responseJson);
            }
        } 
                ...
                <div className="panel panel-default">
                    ...
                    <div className="clearfix">
                        <div className="panel-body">
                            <a className="float-right btn btn-default" href={routeAdmin.registerCourse.path} label="Back to overview" data-ui-loader="">
                                    ...
                                    <div className="form-group field-usereditform-email required">
                                        <label className="control-label" for="usereditform-email">&nbsp;Template <span style={{color:"#ff0404"}}>(*) </span>
                                            ...
                                            <ul className="file-upload-requirement">
                                                <li>
                                                    <a href={file_assets+"template/s2_wishlist_course.xlsx"}>download</a>
                                                </li>
                                            </ul>
                                        </label>
                                    </div>
