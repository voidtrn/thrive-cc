...
function TrainingReportTrainingDetail(props){
    ...
    const getData = async () => {
        ...
        let isi = await axiosLibrary.postData('awbTrainingReport/TrainingDetail',credentials);
    ...
    useEffect(()=>{
        if(props.trainingDetail){
            getData()
        }
    },[props.trainingID, props.trainingDetail])
    ...
    const excelHtml = async () => {
        ...
        let response = await axiosLibrary.postData('awbTrainingReport/ExportDataTraining',credentials);
    ...
    const handleExport = async (e) => {
        ...
        let response = await axiosLibrary.postDataFile("awbTrainingReport/ExportDataTrainingXlsx", param);
        if(response.status === 200){            
...
export default TrainingReportTrainingDetail;