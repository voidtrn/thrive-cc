...
//testing change 24/03/2023 whida
//testing change 27/03/2023 whida
//testing change 10/04/2023 whida
    return(
...
function PointHistory(props){
    ...
    const getTotalPage = useCallback(async () => {
        ...
        let isi = await axiosLibrary.postData('awbPointHistory/ListData',credentials);
                    ...
                    <div className="panel-body">
                        ...
                        <div className="table-responsive">
                            <div className="float-end">
                                <a className="float-end btn btn-primary btn-sm tt" href={routeAdmin.pointHistoryDetail.path} ><i className="fa fa-plus aria-hidden"></i> Upload</a>  
                            </div>
