...
function TermsDetail(props){
    ...
    const getDetail= useCallback(async() =>{
        ...
        if(data.md5ID!== null){
            setEditData(true)
            let response = await axiosLibrary.postData('awbTerms/SelectData',data);
        ...
        if(!cancelDelete){
            if(!deleteData){
                ...
                if(editData){
                    ...
                    let responseJson = await axiosLibrary.postData("awbTerms/UpdateData", fd);
                    if(responseJson.status === 200){
                        alert("DATA HAS BEEN UPDATED");
                        history.push(routeAdmin.terms.path)
                    }else{
                        alert(responseJson);
                    }
                } else {
                    ...
                    let responseJson = await axiosLibrary.postData("awbTerms/InsertData", fd);
                    if(responseJson.status === 200){
                ...
                let responseJson = await axiosLibrary.postData("awbTerms/DeleteData", parameter);
                if(responseJson.status === 200){
        ...
        <div className="panel panel-default">
            ...
            <div className="clearfix">
                <div className="panel-body">
                    <a className="float-right btn btn-default" href={routeAdmin.terms.path} label="Back to overview" data-ui-loader="">
