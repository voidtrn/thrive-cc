...
function ShortcutLink(props){
    ...
    const getDetail=async(param)=>{
        ...
        history.push({
            pathname: routeAdmin.shortcutLinkDetail.path,
    ...
    const moveUp = async(id,sort_index)=>{
        ...
        let responseJson = await axiosLibrary.postData('awbShortcutLink/MoveUp',param);
    ...
    const moveDown = async(id,sort_index)=>{
        ...
        let responseJson = await axiosLibrary.postData('awbShortcutLink/MoveDown',param);
        if(responseJson.status===200){
            getData()
        }else{
            alert(responseJson.status)
    ...
    const deleteItem = async(id)=>{
        ...
        let responseJson = await axiosLibrary.postData('awbShortcutLink/DeleteData',param);
        if(responseJson.status===200){
                    ...
                    <div className="panel-body">
                        ...
                        <div className="table-responsive">
                            <div className="pull-right">
                                <a className="pull-right btn btn-primary btn-sm tt" href={routeAdmin.shortcutLinkDetail.path} ><i className="fa fa-plus aria-hidden="></i> Add new</a>  
                            </div>
