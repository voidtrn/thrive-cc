                ...
                (item) =>
                    <tr key={item.id}>
                        ...
                        <td style={{maxWidth:"250px"}}>
                            <img  style={{width:"90px",height:"auto"}} src={file_path + 'event/' + item.event_image}  alt={item.event_image} />
                        </td>
...
function Event(props){
    ...
    const getTotalPage = useCallback(async () => {
        ...
        let isi = await axiosLibrary.postData('awbEvent/ListData',credentials);
    ...
    const getDetail=async(param)=>{
        ...
        history.push({
            pathname: routeAdmin.eventDetail.path,
    ...
    const moveUp = async(id,sort_index)=>{
        ...
        let responseJson = await axiosLibrary.postData('awbEvent/MoveUp',param);
    ...
    const moveDown = async(id,sort_index)=>{
        ...
        let responseJson = await axiosLibrary.postData('awbEvent/MoveDown',param);
        if(responseJson.status===200){
            getData()
        }else{
            alert(responseJson.status)
    ...
    const deleteItem = async(id)=>{
        ...
        let responseJson = await axiosLibrary.postData('awbEvent/DeleteData',param);
        if(responseJson.status===200){
                    ...
                    <div className="panel-body">
                        ...
                        <div className="table-responsive">
                            <div className="float-end">
                                <a className="float-end btn btn-primary btn-sm tt" href={routeAdmin.eventDetail.path} ><i className="fa fa-plus aria-hidden="></i> Add new</a>  
                            </div>
