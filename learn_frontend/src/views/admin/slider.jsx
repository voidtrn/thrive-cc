                ...
                (item) =>
                    <tr key={item.id}>
                        ...
                        <td> {item.file_type != 'mp4'?
                                <img  style={{width:"90px",height:"auto"}} src={file_path + 'slider/' + item.slider_video} alt={item.slider_video} ></img>
                                :
                                (item.slider_video)
                            }
                        </td>
...
function Slider(props){
    ...
    const moveUp = async(id,sort_index)=>{
        ...
        let responseJson = await axiosLibrary.postData('awbSlider/MoveUp',param);
    ...
    const moveDown = async(id,sort_index)=>{
        ...
        let responseJson = await axiosLibrary.postData('awbSlider/MoveDown',param);
        if(responseJson.status===200){
            getData()
        }else{
            alert(responseJson.status)
    ...
    const deleteItem = async(id)=>{
        ...
        let responseJson = await axiosLibrary.postData('awbSlider/DeleteData',param);
        if(responseJson.status===200){
                ...
                <div className="panel-body">
                    ...
                    <div className="table-responsive">
                        <div className="float-end">
                            <a className="float-end btn btn-primary btn-sm tt" href={routeAdmin.sliderDetail.path} ><i className="fa fa-plus aria-hidden="></i> Add new</a>  
                        </div>
