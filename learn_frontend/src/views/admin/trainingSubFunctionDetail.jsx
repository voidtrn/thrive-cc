            ...
            <div className="panel panel-default">
                ...
                <div className="clearfix">
                    <div className="panel-body">
                        <a className="float-end btn btn-default" href={routeAdmin.trainingAdminSubFunction.path} label="Back to overview" data-ui-loader="">
                                    ...
                                    <Tab.Content animation="true">
                                        <Tab.Pane eventKey="#tab-0">
                                            <div className="mb-3 field-usereditform-username required">
                                                <label className="form-label" htmlFor="usereditform-username">&nbsp;Sub Function Name <span style={{color:"#ff0404"}}>(*)</span></label>
