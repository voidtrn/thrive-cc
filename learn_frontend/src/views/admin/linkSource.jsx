            ...
            {items.map(
                (item) =>
                    <tr key={item.id}>
                        ...
                        <td >{item.md5_code}<br/>
                            <a className="btn btn-success btn-xs tt" onClick={props.copyToClipboard.bind(this,item.md5_code)} >
                                <i className="fa fa-copy"></i>&nbsp; copy link</a>
                        </td>
...
function LinkSource(props){
    ...
    const getTotalPage = useCallback(async () => {
        ...
        let isi = await axiosLibrary.postData('awbLinkSources/ListData',credentials);
    ...
    const getDetail=async(param)=>{
        ...
        history.push({
            pathname: routeAdmin.linkSourceDetail.path,
    ...
    const deleteItem = async(id)=>{
        ...
        let responseJson = await axiosLibrary.postData('awbLinkSources/DeleteData',param);
    ...
    const copyToClipboard = (md5Code) => {
        let linkCopy = hostname +'/?src_token='+md5Code
        ...
        textArea.remove();
        alert("Copied web-link to clipboard");  
	} 
                    ...
                    <div className="panel-body">
                        ...
                        <div className="table-responsive">
                            <div className="pull-right">
                                <a className="pull-right btn btn-primary btn-sm tt" href={routeAdmin.linkSourceDetail.path} ><i className="fa fa-plus aria-hidden"></i> Add New</a>  
                            </div>
