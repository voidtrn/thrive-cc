                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4">
                                {key=='#tab-0'?
                                    ...
                                    <a className="float-end btn btn-primary btn-sm tt" href={routeAdmin.subCategoryDetail.path} ><i className="fa fa-plus aria-hidden="></i> Add new</a>  
                                    </div>
                                :''
                                }
                                {key=='#tab-2'?
                                    <div className="float-end">
                                    <a className="float-end btn btn-primary btn-sm tt" href={routeAdmin.sliderCategoryDetail.path} ><i className="fa fa-plus aria-hidden="></i> Add new</a>  
                                    </div>
                                :''
                                }
                            </div>
