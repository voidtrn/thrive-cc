...
function SliderCategoryDetail(props){
    ...
    const getDetail= useCallback(async() =>{
        ...
        if(data.md5ID!== null){
            setEditData(true)
            let response = await axiosLibrary.postData('awbSliderCategory/SelectData',data);
            if(response.status === 200){
                setItems(response.data.data)
                setFile(file_path+"slider_category/"+response.data.data.slider_video)
        ...
        if(!cancelDelete){
            if(!deleteData){
                ...
                if(editData){
                    ...
                    let responseJson = await axiosLibrary.postData("awbSliderCategory/UpdateData", fd);
                    if(responseJson.status === 200){
                        alert("DATA HAS BEEN UPDATED");
                        history.push(routeAdmin.sliderCategory.path)
                    }else{
                        alert(responseJson);
                    }
                } else {
                    ...
                    let responseJson = await axiosLibrary.postData("awbSliderCategory/InsertData", fd);
                    if(responseJson.status === 200){
                ...
                let responseJson = await axiosLibrary.postData("awbSliderCategory/DeleteData", parameter);
                if(responseJson.status === 200){
        ...
        <div className="panel panel-default">
            ...
            <div className="clearfix">
                <div className="panel-body">
                    <a className="float-end btn btn-default" href={routeAdmin.sliderCategory.path} label="Back to overview" data-ui-loader="">
                            ...
                            <Col sm={12}>
                                <Tab.Content animation="true">
                                    <Tab.Pane eventKey="#tab-0">
                                                ...
                                                editData?
                                                    <div>
                                                        ...
                                                        <input type="text" id="usereditform-email" style={{width:"600px"}} className="form-control" disabled
                                                            name="section_menu" value={itemsCategory.section_title +' > ' + itemsCategory.section_menu} 
                                        ...
                                        <div className="mb-3 field-usereditform-email required">
                                            <label className="form-label" htmlFor="usereditform-email">&nbsp;Sort Number</label>
                                        ...
                                        <div className="mb-3 field-usereditform-email required">
                                            <label className="form-label" htmlFor="usereditform-email">&nbsp;Headline Eng <span style={{color:"#ff0404"}}>(*)</span></label>
                                            <input type="text" id="usereditform-email" style={{width:"75%"}} className="form-control sort_index"
                                        ...
                                        <div className="mb-3 field-usereditform-email required">
                                            <label className="form-label" htmlFor="usereditform-email">&nbsp;Headline Ind <span style={{color:"#ff0404"}}>(*)</span></label>
                                            <input type="text" id="usereditform-email" style={{width:"75%"}} className="form-control sort_index"
                                        ...
                                        <div className="mb-3 field-usereditform-email required">
                                            <label className="form-label" htmlFor="usereditform-email">&nbsp;Article ID <span style={{color:"#ff0404"}}>{editData? '':'(*)'}</span></label>
                                        ...
                                        <div className="mb-3 field-usereditform-email required">
                                            <label className="form-label" htmlFor="usereditform-email">&nbsp;File Media (image / video) for Mobile View <span style={{color:"#ff0404"}}>(*) </span>
                                                <br/> 
                                                <ul className="file-upload-requirement">
                                                    <li>
                                                        one file only
