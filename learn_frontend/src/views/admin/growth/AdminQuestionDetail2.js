        ...
        if (!cancelDelete) {
            if (!deleteData) {
                ...
                if(items.id !=undefined || items.id !=null){
                    ...
                    fd.append("min_character_answer", items.min_character_answer);
                            ...
                            <div className="card card-white">
                                ...
                                <div className="card-body ">
                                    ...
                                    <input type="hidden" name="question_type" id="inputEmail3"   value={items.question_type}  />
                                        ...
                                        <div className="row mb-3">
                                            <label for="inputEmail3correct_point" className="col-sm-2 col-form-label">Correct Point</label>
                                            <div className="col-sm-2">
                                                <input type="number" min="0" required className="form-control" name="correct_point" id="inputEmail3correct_point"   value={items.correct_point}   onChange={handleInputChange} />
                                            </div>
                                        </div>

                                        
                                        <div className="row mb-3">
                                            <label for="inputEmail3min_character_answer" className="col-sm-2 col-form-label">Min Characters for Answer</label>
                                            <div className="col-sm-2">
                                                <input type="number" min="0" required className="form-control" name="min_character_answer" id="inputEmail3min_character_answer"   value={items.min_character_answer}   onChange={handleInputChange} />
                                            </div>
                                        </div>
