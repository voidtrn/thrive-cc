...
function PagesDetail(props){
    ...
    const getDetail= useCallback(async() =>{
        ...
        if(data.md5ID!== null){
            setEditData(true)
            let response = await axiosLibrary.postData('awbPages/SelectData',data);
    ...
    const submit= async (e) =>{
        ...
        if(editData){
            //for edit data
            let responseJson = await axiosLibrary.postData("awbPages/UpdateData", fd);
        ...
        <div className="panel panel-default">
            ...
            <div className="clearfix">
                <div className="panel-body">
                    <a className="float-right btn btn-default" href={routeAdmin.pages.path} label="Back to overview" data-ui-loader="">
