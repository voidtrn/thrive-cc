        ...
        <div className="panel panel-default">
            ...
            <div className="clearfix">
                <div className="panel-body">
                    <a className="float-end btn btn-default" href={routeAdmin.webConfig.path} label="Back to overview" data-ui-loader="">
            ...
            <div className="panel-body" style={cssTarget(loading)}>
                <form id="czfrom" onSubmit={submit} method="post" style={{display: "block"}} encType='multipart/form-data'>
                    ...
                    <div className="mb-3 field-usereditform-email">
                        <label className="form-label" htmlFor="usereditform-email">&nbsp;Config </label>
                    ...
                    <div className="mb-3 field-usereditform-email">
                        <label className="form-label" htmlFor="usereditform-email">&nbsp;Value </label>
