            ...
            <div className="panel panel-default">
                ...
                <div className="clearfix">
                    <div className="panel-body">
                        <a className="float-end btn btn-default" href={routeAdmin.course.path} label="Back to overview" data-ui-loader="">
                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <div className="form-group field-usereditform-email required">
                                                        ...
                                                        <br/>
                                                        <span className='badge bg-primary' id="upload-name" name="upload-name">{items.home_image}</span>
                                                ...
                                                <div className="col-md-6">
                                                    <div className="form-group field-usereditform-email required">
                                                        ...
                                                        <br/>
                                                        <span className='badge bg-primary' id="upload-name-course" name="upload-name-course">{items.course_image}</span>
