        ...
        <div className="panel panel-default">
            ...
            <div className="clearfix">
                <div className="panel-body">
                    <a className="float-right btn btn-default" href={routeAdmin.learningSupport.path} label="Back to overview" data-ui-loader="">
                                    ...
                                    <Tab.Pane eventKey="#tab-0">
                                        ...
                                        <div className="form-group">
                                            <div className="form-group field-usereditform-email required">
                                                ...
                                                <br/>
                                                <span className='badge badge-primary' id="upload-name" name="upload-name">{items.logo_image}</span>
