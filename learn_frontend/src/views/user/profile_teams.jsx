...
function ProfileTeams(props){
    ...
    const [user_id, setUserID] = useState(props.location.id)
    const [user_account,setUserAccount] = useState(props.location.account)
    const [name, setName] = useState(props.location.name)
    const [access_other_profile, setAccess] = useState(props.location.access_other_profile)
    // const redeem_point = props.location.redeem_point
    ...
    const getAccount = useCallback(async () => {
        setLoading(true)
        const data = {
            account: new URLSearchParams(props.location.search).get('uac'),
    ...
    const getProfile = async() => {
        setLoading(true)
        if(profile.account!=undefined || profile.account!=null){
    ...
    const getDetail=async(param)=>{
        ...
        history.push({
            ...
            search: "?" + new URLSearchParams({uac: acc}).toString()// your data array of objects
        })
    ...
    const getListReward = async () => {
        ...
        const credentials = {
            platform_id:platform_id,
            user_id: user_id,
            directorate: securityData.Security_UserDirectorate_3()
        };
    ...
    const ChangeScroll = (param) =>{
        if (param=="left"){
            ...
            setScrollerMargin("-512px")
        }
    }
    const ShowPopUp = (param) =>{
        if(access_other_profile==false){
        setModalRedeem(true)
        setIdReward(param)
        }
    }
...
/*
  ...
  */  
    ...
    useEffect(()=>{
        if(user_id!=null || user_id=="undefine"){
    ...
    useEffect(()=>{
        if(profile.Cz_awb_level_idx != "undefine"){
            getCurrentImage()
    ...
    const [stateLearningPlan, setStateLearningPlan] = useState({
        user_id:'',
        user_account:'',
        dataLearningPlan:[],
        dataLearningPlanCompleted:[],
        filterCategory:[],
        selectedCategory:"",
        filterYear:[],
        selectedYear:"",
        ...
        if(securityData.Security_getPlatformId()){
            if(querystring){
                if(querystring.data){
                    ...
                    if(isiData.account === querystring.uac){
                        changeTab("MyLearningPlan")
                        setStateLearningPlan(state =>({...state,user_id:isiData.id,user_account:isiData.account}))
                    }else{
                ...
                <div  className="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div  className="row col-md-12" style={{top: "-10px", position: "relative"}}>
                        ...
                        <div  className="col-md-2">
                            ...
                            <div  className="profile-img" title={name == null? profile.name: name}
                                ...
                                <div  className="col-md-3" >
                                    <div  className="your-current-level-and-points">
                                        <a onClick={changeTab.bind(this, "RedeemPoints")} style={{cursor:"pointer"}}>
                                            <span  className="user-points"> {redeem_point ? redeem_point : profile.Cz_awb_point} </span>
...
<div  className="tab-content profile-tabs-containter">
    <div id="LevelProgress"  className={tab == "LevelProgress" ? "tab-pane active show": "tab-pane"}>
        <div  className="content-level-progress">
            <div  className="row">
                <div  className="col-md-3">
                    <div  className="level-progress-image" title={profile.Cz_awb_level}
                ...
                <div  className="col-md-3">
                    <h1  className="user-level">{profile.Cz_awb_level}</h1>
                </div>
                ...
                <div  className="col-md-3">
                        ...
                        <div  className="progress-tier-point">
                            ...
                            <span  className="progress-percent" style={{display:"none",transform: "rotate("+ (45+( profile.target_point <= profile.tier_point ? 100 : profile.progressLevel *1.8)) +"deg)"}}>  
                                {  
                        ...
                        <div key={itemTopic.id}  className="row content-viewed-item">
                            ...
                            <div  className="col-md-3" >
                                <div  className="viewed-date"> 
                                    <span>  { securityData.Security_lang() == "ENG" ?  "content" + itemTopic.total  > 1 ? "s" :   +  "viewed" :  itemTopic.total + " konten yang dilihat"  }</span>
                                </div>
                            </div>
                        </div>
                    </>
                ...
                <div  className="content-viewed">
                    ...
                    <div  className="referral-link">
                        <input type="text" 
                            ...
                            value={window.location.origin+routeAll.routesUser.profile.path+"?refer="+user_account} id="txtReferralLink"/>
                         
                        <button   className="btn btn-outline-white btn-copy-link" onClick={() => {navigator.clipboard.writeText(window.location.origin+routeAll.routesUser.profile.path+"?refer="+user_account)}}>copy link</button>
                    </div>
            ...
            <div id="CourseAttended"  className={tab == "CourseAttended" ? "tab-pane active show": "tab-pane"}>
                <div  className="content-course-attended">
                                ...
                                <div  className="col-md-3">
                                    <div  className="item-action">
                                        { access_other_profile ? "" :
                                            <a onClick={courseEdit.bind(this, itemCourse.id)} >Edit</a>
                                            |
                                            <a onClick={courseDelete.bind(this, itemCourse.id)} >Delete</a>
                                        }
                                    </div>                            
                                </div>
                    ...
                    loading?
                        ...
                        :     
                    <form id="formCourseAttended" key={raCourse.id} autocomplete="off" encType='multipart/form-data' accept-charset="UTF-8"  
                ...
                {loading?
                     ...
                     (itemTeams) =>
                     {
                            ...
                            <div key={itemTeams.id}  className="row my-team-item">
                                ...
                                <div  className="col-md-4">
                                    <div  className="user-identity">
                                        <a  target="_blank" onClick={getDetail.bind(this, itemTeams.account)} >
                                ...
                                <div  className="col-md-6" >
                                    <div className="d-flex flex-row justify-content-between align-items-center">
                                        ...
                                        <div  className="point-profile">
                                            <a href={`${routeAll.routesUser.profile.path}?tabs=learning&data=${axiosLibrary.decodeEncodeUri('?id='+itemTeams.id,'encode')}`}>
    ...
    <div id="MyLearningPlan"   className={tab == "MyLearningPlan" ? "tab-pane active show": "tab-pane"}>
        ...
        <div style={cssTarget(global.loadLearningPlan)}>
            <ProfileMyLearningPlan data={stateLearningPlan} tab={tab}/>
        </div>
    </div>
            ...
            <div id="PreferredTopic"  className={tab == "PreferredTopic" ? "tab-pane active show": "tab-pane"}>	
                <div  className="content-badges-achieved">	
                    ...
                    <form  id="formPreferredTopic" enctype="multipart/form-data" accept-charset="UTF-8" style={{paddingLeft:"10%"}}>	
                        ...
                        <>
                            {
                                readLeaderboard.map(
                                    (itemReadLeaderboard, index)=>
                                    {
                                        if(index < 10){
                                            return(
                                            <div key={itemReadLeaderboard.id} className={ itemReadLeaderboard.user_modified == user_id ? "row rowleaderboardFromId" : "row rowleaderboard" }>
                                                <div  className='col-sm-1 itemLeaderboard'>
                                                    { itemReadLeaderboard.iterator }
                                                </div>
                                                <div  className='col-sm-8 itemPicName'>
                                                    ...
                                                    </div><div>&nbsp;   {itemReadLeaderboard.user_modified == user_id ? "You" : itemReadLeaderboard.name }</div>
                                ...
                                <div  className="row justify-content-center redeem-reward-title">
                                    ...
                                    <div  className="container containter-redeem">
                                        <div  className="row div-list-reward">
                                            <div  className="col-md-12" style={{backgroundImage: "linear-gradient(to right, #27bfff, #8078f1)", minHeight: "100%", borderRadius:"20px", padding:"0", margin:"0", zIndex:"1"}}>
                                                            ...
                                                            <>
                                                                <div key={itemListUserLevel.id}  className="col-md-12 row" style={{margin: "20px 0px"}}>
                                                                    <div  className="col-md-3" style={{margin: "0", padding:"0"}}>
                                                                        <h4>
                                                                            {  profile.Cz_awb_tier_point < itemListUserLevel.points_needed  ? 
                                                                                    ...
                                                                                    <div  className="redeem_box white_bg team_hover_style2 social_white" style={{padding:"0px", background:"transparent", height:"100%"}}>
                                                                                        <div  className="redeem_box" style={{borderRadius:"20px", height:"100%",  boxShadow: "5px 5px rgb(0,0,0, 0.1)"
                                                                                            , background: 
                                                                                                ...
                                                                                                || 
                                                                                                    ( profile.Cz_awb_tier_point <  itemListReward.claim_point )
                                                                                                || 
                                                                                                    ( profile.Cz_awb_tier_point >= itemListReward.minimum_claim_level )
                                                                                                )
                                                                                                ?
                                                                                                "white"
                                                                                                :"transparent"
                                                                                        ...
                                                                                        <div  className="team_img">
                                                                                            <img src={file_path+"reward/"+itemListReward.reward_image} alt={itemListReward.reward_image}/>
                                                                                                ...
                                                                                                {profile.Cz_awb_point <   itemListReward.claim_point ?  
                                                                                                        ...
                                                                                                        profile.Cz_awb_point < itemListReward.claim_point  ?
                                                                                                                <>
                                                                                                                    <a   className="btn btn-outline-white popup-btn-cta redeem-enabled">
                                                                                                                        {"- "+(itemListReward.claim_point - profile.Cz_awb_point) + "poin"}
                                                                                                                    </a>
                                                                                                            ...
                                                                                                            : 
                                                                                                                <>
                                                                                                                    <a onClick={ShowPopUp.bind(this, itemListReward.id)}   
                                                                                                                    className={access_other_profile ?
                                                                                                                        "btn btn-outline-white popup-btn-cta redeem-disabled"
                                                                                                                        :
                                                                                                                        "btn btn-outline-white popup-btn-cta redeem-enabled"
                                                                                                                    }>
