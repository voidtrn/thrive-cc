...
function AnswerQuiz4(props) {
  ...
  const submit = async () => {
    ...
    if (IsFileAttached) {
      fd.append("upload_image_score", fileInput.current.files[0]);
    }
    ...
    let responseJson = await axiosLibrary.postData("awbHutUser/AnswerQuiz", fd);
  ...
  const getAnswerUser = async () => {
    ...
    if (isi.status === 200) {
      ...
      setState(state => ({ ...state, imageLink: isi.data.image_name , ideaText: isi.data.answer  }))
                    ...
                    <div id="challenge4">
                      ...
                      <div className="row d-flex">
                        ...
                        <div className="col-lg-11 mt-2">
                          ...
                          <input type="file"
                            name="ig_image" id="ig_image" required className="form-control" size="40" accept="image/jpg,image/png,image/jpeg,image/gif"
                            ref={fileInput} onChange={ajaxFileUploadImage.bind(this)} />
                          <img style={{ width: "auto", height: "100px" }} src={file} alt="" onError={addDefaultSrc} className="mt-1" />
                          <div className='title-content' id="upload-name" name="upload-name"></div>
                      ...
                      <div className="row d-flex">
                        ...
                        <div className="col-lg-11 title-text-black mt-2">
                          <textarea required className="form-control" onChange={handleChange.bind(this)} name="idea_score" id="idea_score" rows="5" />
                        </div>
                      </div>
                      ...
                      <div className="row d-flex mb-4 mt-4">
                        ...
                        <div className="col-lg-11 title-text-black">
                          {buttonLoading ? <button  type="submit" className="btn btn-primary" name="btnSubmit" value="save">
                            submit
                          </button> : <div className="title-content">Loading ...</div> }
...

              {
                state.isThanks ?
                  <>
                    ...
                    <div className="card-body ">
                    <div className="row d-flex">
                      <div className="col-lg-1 title-content  title-text-black">
                        1.
                      </div>
                      <div className="col-lg-11  title-text-black">
                        {t('textUnggahImage')}
                    ...
                    <div className="row d-flex">
                      <div className="col-lg-1 title-content ">
                    
                      </div>
                      <div className="col-lg-11 ">
                        <a href={file_path+"sources/"+state.imageLink} target="_BLANK" rel="noopener noreferrer"  className="title-content-a">See Image</a>
                      </div>
                    </div>
                    ...
                    <div className="row d-flex">
                      ...
                      <div className="col-lg-11 title-content">
                       {state.ideaText}
                      </div>
                    </div>
                    </div>
