...
class securityData{
    ...
    static Security_choose_languange(lang = ''){        
        return localStorage.getItem("languange");
    }    
    static Security_point(){
        const dataUser = axiosLibrary.getUserInfo();
        if(dataUser===null){
            return false
        }else{
...
const typePageMenuNCategory = [
    {id:0,title:"Default Page", hrefLinkCategory:`${routeAll.routeViewAll.cate.path}?cate=[variable1]`, hrefLinkMenu:`${routeAll.routeViewAll.page.path}?menu=[variable1]`},
    {id:1,title:"Custom Page", hrefLinkCategory:`${routeAll.routeViewAll.customPage.path}?cate=[variable1]`, hrefLinkMenu:`${routeAll.routeViewAll.customPage.path}?menu=[variable1]`},
    {id:2,title:"Special Page", hrefLinkCategory:`${routeAll.routeViewAll.specialPage.path}?cate=[variable1]`, hrefLinkMenu:`${routeAll.routeViewAll.specialPage.path}?menu=[variable1]`},
    {id:3,title:"Menu Special", hrefLinkCategory:`${routeAll.routeViewAll.menuSpecial.path}?cate=[variable1]`, hrefLinkMenu:`${routeAll.routeViewAll.menuSpecial.path}?menu=[variable1]`},
    {id:4,title:"Skill For Future Page", hrefLinkCategory:`${routeAll.routesUser.viewcourseDetail.path}?category=[variable1]`, hrefLinkMenu:routeAll.routesUser.viewcourse.path},
    {id:5,title:"Training Page", hrefLinkCategory:routeAll.routesUser.training.path, hrefLinkMenu:routeAll.routesUser.training.path},
    {id:6,title:"RRP Page", hrefLinkCategory:`${routeAll.routeViewAll.cate.path}?cate=[variable1]`, hrefLinkMenu:`${routeAll.routeViewAll.page.path}?menu=[variable1]`},
    {id:7,title:"PBO campus Page", hrefLinkCategory:`https://thrive.pmiapps.biz/thrive/awb/campus`, hrefLinkMenu:`https://thrive.pmiapps.biz/thrive/awb/campus`},
    {id:8,title:"Digital Campus Page", hrefLinkCategory:`https://pmi.fuseuniversal.com/communities/23189`, hrefLinkMenu:`https://pmi.fuseuniversal.com/communities/23189`},
]
