                                ...
                                <form id="formSubmittedArticle" key={items.id} autocomplete="off"  enctype="multipart/form-data" accept-charset="UTF-8"  method="post">		
                                    <div className="containerArticle">		
                                        <div className="mb-3 field-usereditform-email">		
                                            <label className="form-label" for="usereditform-email">&nbsp;Title<span style={{ color: "#ff0404" }}>(*)</span></label>		
                                        ...
                                        <div className="mb-3 field-usereditform-email">		
                                            <label className="form-label" for="usereditform-email">&nbsp;Short Description<span style={{ color: "#ff0404" }}>(*)</span></label>		
                                        ...
                                        <div className="mb-3 field-usereditform-email">		
                                            <label className="form-label" for="usereditform-email">&nbsp;Document<span style={{ color: "#ff0404" }}>(*)</span></label>		
