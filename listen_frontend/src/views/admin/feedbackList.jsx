                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <div className="float-end">
                                    <button className="float-end btn btn-primary btn-sm tt" onClick={resetFlag} style={{marginLeft:5}} ><i className="fa fa-plus aria-hidden="></i> Reset Apps Feedback</button>  
                                    <a className="float-end btn btn-primary btn-sm tt" href={routeAdmin.feedbackListDetail.path} ><i className="fa fa-plus aria-hidden="></i> Add new</a>  
                                </div>
                            </div>
                        </div>
                    </div>
