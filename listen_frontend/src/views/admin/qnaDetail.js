            ...
            <div className="panel panel-default">
                ...
                <div className="clearfix">
                    <div className="panel-body">
                        <a className="pull-right btn btn-default" href={routeAdmin.qna.path} label="Back to overview" data-ui-loader="">
                        ...
                        <div className="tab-content">
                            <div className="tab-pane active" data-tab-index="0" id="tab-0">
                                <div className="form-group field-usereditform-email required">
                                    <label className="control-label" htmlFor="usereditform-email">&nbsp;Question (Primary) <span style={{color:"#ff0404"}}>(*) max 5000 chars</span></label>
                                ...
                                <div className="form-group field-usereditform-email required">
                                    <label className="control-label" htmlFor="usereditform-email">&nbsp;Question (Secondary) <span style={{color:"#ff0404"}}>(*) max 5000 chars</span></label>
                                ...
                                <div className="form-group field-usereditform-email required">
                                    <label className="control-label" htmlFor="usereditform-email">&nbsp;Answer (Primary) <span style={{color:"#ff0404"}}>(*) max 5000 chars</span></label>
                                ...
                                <div className="form-group field-usereditform-email required">
                                    <label className="control-label" htmlFor="usereditform-email">&nbsp;Answer (Secondary) <span style={{color:"#ff0404"}}>(*) max 5000 chars</span></label>
                                ...
                                <div className="form-group field-usereditform-email required">
                                    <label className="control-label" htmlFor="usereditform-email">&nbsp;Answered By <span style={{color:"#ff0404"}}>(*) </span></label>
                                ...
                                <div className="form-group field-usereditform-email required">
                                    <label className="control-label" htmlFor="usereditform-email">&nbsp;Profile Image <span style={{color:"#ff0404"}}>(*) max upload file size : 500 KB, image resolution : (200 px * 200 px)</span></label>
                                    <input type="file"  
