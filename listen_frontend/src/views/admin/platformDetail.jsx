...
function PlatformDetail(props){
    ...
    const getAllEmpl= useCallback(async () =>{
        ...
        let responseJson = await axiosLibrary.postData("dialoguePlatform/GetAllEmployee",param);
    ...
    const getAllFunction= useCallback(async () =>{
        let responseJson = await axiosLibrary.getData("dialoguePlatform/GetAllFunction",config);
        if(responseJson.status === 200){
    ...
    const getPlatformDtl=useCallback(async()=>{
        ...
        if(data.md5ID!== null){
            setEditData(true)
            let responseJson = await axiosLibrary.postData("dialoguePlatform/SelectData",data);
            if(responseJson.status === 200){
                            ...
                            <div className="tab-content">
                                <div className="tab-pane active" data-tab-index="0" id="tab-0">
                                    <div className="mb-3 field-usereditform-email required">
                                        <label className="form-label">&nbsp;Platform Name <span style={{color:"#ff0404"}}>(*)</span></label>
                                    ...
                                    <div className="mb-3 field-usereditform-email required">
                                        <label className="form-label" >&nbsp;Platform Image <span style={{color:"#ff0404"}}>(*) max upload file size : 300 KB, image resolution : (200 px * 200 px)</span></label>
                                        <input type="file"  
                                    ...
                                    <div className="mb-3 field-usereditform-email required">
                                        <label className="form-label">&nbsp;IMDL <span style={{color:"#ff0404"}}>(*)</span></label>
                                    ...
                                    {/* <div className="mb-3 field-usereditform-email required">
                                        <label className="form-label">&nbsp;Energy Points <span style={{color:"#ff0404"}}>(*)</span></label>
                                    ...
                                    <div className="mb-3 field-usereditform-email required">
                                        <label className="form-label" >&nbsp;Ad Hoc User</label>
