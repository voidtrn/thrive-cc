...
function SliderDetail(props){
    ...
    const getDetail= useCallback(async() =>{
        ...
        if(data.md5ID!== null){
            setEditData(true)
            let response = await axiosLibrary.postData('dialogueSlider/SelectData',data);
            
            if(response.status === 200){
                setItems(response.data.data)
                setFile(file_path+"slider/"+response.data.data.slider_image)
            }else{
                alert(response);
            }
        }
            ...
            <div className="panel panel-default">
                ...
                <div className="clearfix">
                    <div className="panel-body">
                        <a className="pull-right btn btn-default" href={routeAdmin.slider.path} label="Back to overview" data-ui-loader="">
