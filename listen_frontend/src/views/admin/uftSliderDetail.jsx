                ...
                if(!deleteData){
                    ...
                    if(editData){
                        ...
                        if(responseJson.status === 200){
                            ...
                            history(routeAdmin.uftSlider.path)
                        }else{
                            alert(responseJson);
                        }
                    }else{
            ...
            <div className="panel panel-default">
                ...
                <div className="clearfix">
                    <div className="panel-body">
                        <a className="float-end btn btn-default" href={routeAdmin.uftSlider.path} label="Back to overview" data-ui-loader="">
                        ...
                        <div className="tab-content">
                            <div className="tab-pane active" data-tab-index="0" id="tab-0">
                                <div className="mb-3 field-usereditform-email required">
                                    <label className="form-label" htmlFor="usereditform-email">&nbsp; <span style={{color:"#ff0404"}}>(*) </span></label>
                                ...
                                <div className="mb-3 field-usereditform-email required">
                                    <label className="form-label" htmlFor="usereditform-email">&nbsp; Image <span style={{color:"#ff0404"}}>(*) max upload file size : 300 KB, image resolution : (1300 px * 400 px)</span></label>
                                    <input type="file"  
