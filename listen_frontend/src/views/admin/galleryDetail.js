            ...
            <div className="panel panel-default">
                ...
                <div className="clearfix">
                    <div className="panel-body">
                        <a className="pull-right btn btn-default" href={routeAdmin.gallery.path} label="Back to overview" data-ui-loader="">
                        ...
                        <div className="tab-content">
                            <div className="tab-pane active" data-tab-index="0" id="tab-0">
                                <div className="form-group field-usereditform-email required">
                                    <label className="control-label" htmlFor="usereditform-email">&nbsp;Caption <span style={{color:"#ff0404"}}>(*) </span></label>
                                ...
                                <div className="form-group field-usereditform-email required">
                                    <label className="control-label" htmlFor="usereditform-email">&nbsp;Image <span style={{color:"#ff0404"}}>(*) max upload file size : 1 MB, image resolution : (760 px * 350 px)</span></label>
                                    <input type="file"  
