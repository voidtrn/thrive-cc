            ...
            <div className="panel panel-default">
                ...
                <div className="clearfix">
                    <div className="panel-body">
                        <a className="pull-right btn btn-default" href={routeAdmin.schedule.path} label="Back to overview" data-ui-loader="">
                    ...
                    <form id="czfrom" onSubmit={validateImage} method="post" style={{display: "block"}} encType='multipart/form-data'>
                        ...
                        <div className="tab-content">
                            <div className="tab-pane active" data-tab-index="0" id="tab-0">
                                ...
                                <div className="form-group field-usereditform-email required">
                                    <label className="control-label" htmlFor="usereditform-email">&nbsp;Place <span style={{color:"#ff0404"}}>(*) </span></label>
                                ...
                                <div className="form-group field-usereditform-email required">
                                    <label className="control-label" htmlFor="usereditform-email">&nbsp;Time <span style={{color:"#ff0404"}}>(*) </span></label>
                                ...
                                <div className="form-group field-usereditform-email required">
                                    <label className="control-label" htmlFor="usereditform-email">&nbsp;Total Participant <span style={{color:"#ff0404"}}>(*) </span></label>
                                ...
                                <div className="form-group field-usereditform-email required">
                                    <label className="control-label" htmlFor="usereditform-email">&nbsp;Profile Image <span style={{color:"#ff0404"}}>(*) max upload file size : 1 MB, image resolution : (300 px * 300 px)</span></label>
                                    <input type="file"  
