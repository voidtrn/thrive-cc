            ...
            {items.map(
                (item) =>
                    <tr key={item.id}>
                        ...
                        <td> <img  style={{ width:"160px", height:"auto" }} src={file_path+ "uft_slider/" + item.slider_image}    alt="" />
                        </td>
                        <td>
...
function UftSlider(props){
    ...
    const getDetail=async(param)=>{
        ...
        history.push({
            pathname: routeAdmin.uftSliderDetail.path,
                ...
                <div className="panel-body">
                    ...
                    <div className="table-responsive">
                        <div className="pull-right">
                            <a className="pull-right btn btn-primary btn-sm tt" href={routeAdmin.uftSliderDetail.path} ><i className="fa fa-plus aria-hidden="></i> Add new</a>  
                        </div>
