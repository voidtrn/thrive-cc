                    ...
                    <div className="table-responsive">
                        <div className="grid-view">
                            <div className="summary">
                                ...
                                {/* <button type="submit" id="btnMassUpdate" name="btnMassUpdate" style={{margin: "5px 0px",backgroundColor: "#4e53de"}} class="btn btn-primary btn-sm pull-right">mass update</button> */}
                            </div>
                            {loading? 
