...
function ReportDialogueFeedback(props){
    ...
    const handleExport = async (e) => {
        ...
        if(response.status === 200){            
            ...
            link.href = url;
            link.setAttribute('download', `report_dialogue_feedback_${moment().format('YYYYMMDDHHmmss')}.xlsx`);
...
export default ReportDialogueFeedback;