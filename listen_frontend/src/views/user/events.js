                ...
                <div className="tab-content">
                    <div className="tab-pane active" data-tab-index="0" id="tab-0">
                        <div className="form-group field-usereditform-email required">
                            <label className="control-label">&nbsp;{theme.txt_popup_dialogue_employee_name}: <span style={{color:'#ff0404'}}>(*)</span></label>
                        ...
                        <div className="form-group field-usereditform-email required">
                            <label className="control-label" >&nbsp;{theme.txt_popup_dialogue_host_function}: <span style={{color:'#ff0404'}}>(*)</span></label>
                        ...
                        <div className="form-group field-usereditform-email required">
                            <label className="control-label" >&nbsp;{theme.txt_popup_dialogue_host_name}: <span style={{color:'#ff0404'}}>(*)</span></label>
                            <Select components={animatedComponents} 
            ...
            <div className="col-xs-12 col-sm-6 col-lg-4" key={item.id}>
                ...
                >
                    ...
                    <div className="event-content">
                        ...
                        <button className={profileHover===item.id ? 'btn-event-submit pull-right btn-selected' : 'btn-event-submit pull-right'}>{theme.txt_dialogue_submit}</button>
                    </div>
                </div>
            </div>
        )}
