                ...
                <div className="tab-content">
                    <div className="tab-pane active" data-tab-index="0" id="tab-0">
                        ...
                        <div className="form-group field-usereditform-email required">                                
                            ...
                            <a onClick={()=>setModalShow(false)} className="close pull-right a-not-now" data-dismiss="modal" aria-hidden="true">{theme.txt_popup_feedback_not_now}</a>
                            <br/>
                        </div>
            ...
            <Modal.Body>
                <div className="tab-content">
                    <div className="tab-pane active" data-tab-index="0" id="tab-0">
                        ...
                        <div className="form-group field-usereditform-email required">
                                <label className="control-label lbl-rating" style={{float:'right'}}>&nbsp;{theme.txt_popup_rating_boundaries_comment}</label>
