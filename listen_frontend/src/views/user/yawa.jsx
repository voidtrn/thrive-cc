                ...
                <div className="tab-content">
                    <div className="tab-pane active" data-tab-index="0" id="tab-0">
                        ...
                        <div className="mb-3 field-usereditform-email required">
                            <label className="form-label" htmlFor="usereditform-email">&nbsp;{theme.txt_popup_yawa_to} : <span style={{color:'#ff0404'}}>(*)</span></label>
                            <div id="listResults" className="float-end">
                        ...
                        <div className="mb-3 field-usereditform-email required" id="div_hof_other" style={{display:showInputOtherHof?'block':'none'}}>
                        ...
                        <div className="mb-3 field-usereditform-email required">
                            <label className="form-label" htmlFor="usereditform-email">&nbsp;Message : <span style={{color:'#ff0404'}}>(*)</span></label>
