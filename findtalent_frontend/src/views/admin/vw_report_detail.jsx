...
class vw_activitylog extends Component{
    ...
    getData = async () => {
        ...
        let isi = await AuthHelpers.postData('findTalentReport/ListDataReportDetail',credentials);
    ...
    handleExport = async(e) => {
        ...
        let response = await AuthHelpers.postDataFile("findTalentReport/FormExportReportDetail", param);
        if(response.status == 200){            
            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'report_detail.xlsx');
    ...
    handleSubmit = async(e) => {
        ...
        // console.log(param);
        let isi = await AuthHelpers.postData("findTalentReport/ListDataReportDetail", param);
        // console.log(isi);
        if(isi.status == 200){
                ...
                <div className="col-md-9">
                    <div className="panel panel-default">
                        <div className="panel-heading">
                            <strong>Report Detail</strong> Raw Data</div>
