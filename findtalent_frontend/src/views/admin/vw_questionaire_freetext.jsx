        ...
        if(!this.state.cancelDelete){
            if(!this.state.deleteData){
                if (this.validateForm()) {
                    ...
                    fd.append("question_type", "freetext");
                    fd.append("status_active", param.status_active);
                    fd.append("radio_option_1", "-");
                    fd.append("radio_option_2", "-");
                            ...
                            <div className="tab-content">
                                <div className="tab-pane active" data-tab-index="0" id="tab-0">
                                    ...
                                    <div className="form-group field-usereditform-email required">
                                        ...
                                        <input type="text" id="usereditform-question" style={{width:"75%"}} className="form-control" name="question" maxLength="200"  value={items.question} onChange={this.handleInputChange}  required aria-required="true" aria-invalid="false"/>
