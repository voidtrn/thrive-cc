...
class vw_slider_dtl extends Component{
            ...
            if(!this.state.deleteData){
                if (this.validateForm()) {
                   ...
                   // fd.append("slider_file", param.slider_image);
                    ...
                    if(IsFileAttached) 
                    fd.append("slider_image", this.fileInput.current.files[0]);
                ...
                let responseJson = await AuthHelpers.postData("findTalentSlider/DeleteData", parameter);
    ...
    render(){
        const {items, editData, file} = this.state;
        return(
            <>
                            ...
                            <div className="tab-content">
                                <div className="tab-pane active" data-tab-index="0" id="tab-0">
                                    ...
                                    <div className="form-group field-usereditform-email required">
                                        <label className="control-label" htmlFor="usereditform-email">&nbsp;Slider <span style={{color:"#ff0404"}}>(*) </span></label>
                                        <input type="text" id="usereditform-email" style={{width:"75%"}} className="form-control" name="name" value={items.name} onChange={this.handleInputChange}  required aria-required="true" aria-invalid="false"/>

                                        <div className="help-block"></div>
                                    </div>
                                    <div className="form-group field-usereditform-email required">
                                        <label className="control-label" htmlFor="usereditform-email">&nbsp;Hyperlink (optional, sample : http://www.google.co.id)</label>
                                        <input type="text" id="usereditform-email" style={{width:"75%"}} className="form-control" name="hyperlink" value={items.hyperlink} onChange={this.handleInputChange}  aria-required="true" aria-invalid="false" />

                                        <div className="help-block"></div>
                                    </div>
                                    <div className="form-group field-usereditform-email required">
                                        <label className="control-label" htmlFor="usereditform-email">&nbsp;Slider Image <span style={{color:"#ff0404"}}>(*) max upload file size : 300 KB, image resolution : (1300 px * 400 px)</span></label>
                                        <br/>
                                        <input type="file"  
                                         ...
                                         <br/><img style={{width:"160px",height:"auto"}}  src={file}    alt="" onError={this.addDefaultSrcImg} />
                                        <br/>
                                        <span className='label btn-primary' id="upload-name" name="upload-name"> {items.slider_image==""? "images": items.slider_image} </span>                                        
                                        <div className="help-block"></div>
                                    </div>
                                    <div className="form-group field-usereditform-email required">
