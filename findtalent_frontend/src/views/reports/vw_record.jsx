...
class vw_record extends Component{
    ...
    getData = async () => {
        ...
        const credentials = {
         ...
         let isi = await AuthHelpers.postData('thinkReport/ListDataRecord',credentials);
    ...
    handleExport = async(e) => {
        ...
        if(response.status == 200){            
            ...
            link.href = url;
            link.setAttribute('download', 'individual_record.xlsx');
    ...
    handleSubmit = async(e) => {
        ...
        //console.log(param);
        let isi = await AuthHelpers.postData("thinkReport/ListDataRecord", param);
        if(isi.status == 200){
            ...
            <div className="col-md-12">
                <div className="panel panel-default">
                    <div className="panel-heading">
                        <strong>Report</strong> Individual Record   
                    </div>
                            ...
                            { items.map((item, id) => 
                                <tr key={id}>
                                   <td>{item.participant_id}</td>
                                    ...
                                    <td>{item.participant_comment}</td>
...
export default withRouter(vw_record);
